...
/**
 * Debug endpoint: returns this agent's SPIFFE identity (decoded JWT-SVID claims).
 * Unauthenticated, like the other workloads' /spiffe-id; never returns the raw JWT.
 */
