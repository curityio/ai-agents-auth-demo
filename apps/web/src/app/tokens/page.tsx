...
import { SessionTokensView } from '@/components/session-tokens-view';
...
export default async function SessionTokensPage() {
      ...
      <header className="mb-8 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="leading-tight">
            <h1 className="text-lg font-bold tracking-tight">Session tokens</h1>
