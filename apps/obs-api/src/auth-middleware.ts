...
export function authMiddleware(cfg: Config) {
  return async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    try {
      ...
      //    chain, fine-grained length/order/unknown codes), obs-api accepts
      ...
      // No acr gate — the read path is unprivileged (matches mcp-observability).
      ...
      console.error('[obs-api/auth-middleware] unexpected error', e);
